...
export const MY_GOALS = {
  weeklyFitness: 4,      // 本周健身目标次数
  weeklyStudy: 5,        // 本周学习目标次数
  weeklyFitnessDone: 2,  // 已完成
  weeklyStudyDone: 3,    // 已完成
  monthTarget: 30,       // 本月目标天数
  monthDone: 18,         // 已完成
  mantra: '每天进步1%，一年后强大37倍', // 个人宣言
};

// 鞭策语录
export const PUSH_QUOTES = [
  '你今天偷的懒，是明天流的泪',
  'Stars已经打卡了，你还在等什么？',
  '别让昨天的自己看不起今天的你',
  '坚持不是因为我喜欢，而是因为我不服',
